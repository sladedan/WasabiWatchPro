...
while True:
    ...
    # if the barcode has not been seen before, this means it's a new plate being added to the train
    if barcode not in plates:
    ...
    # if the barcode is scanned again, calculate and show how long it has been on the train
    else:
